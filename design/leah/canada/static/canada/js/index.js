...
var answer1 = ["<button id=btn2>A</button>Due to reaction with SO2",
    "Pollution",
    "Friction",
    "I don't know"];
  ...
  let incorrect = ["<button class=buttons002> <- </button>Incorrect!!!! Try Agin",
  ...
  Slider.prototype.startbutton = function () {
